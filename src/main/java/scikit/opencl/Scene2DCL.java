...
/**
*       Scene2DCL is an OpenCL extension of the scene class for 2D scenes.
* 
* 
* <br>
* 
...
* @since       2013-07
*/
abstract public class Scene2DCL extends SceneCL<Gfx2D> {
	...
	public Scene2DCL(String title, CLHelper clin) {
            super(title,clin);
        }
